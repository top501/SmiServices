...
| Magick.NET-Q16-AnyCPU | [GitHub](https://github.com/dlemstra/Magick.NET) | [7.15.5](https://www.nuget.org/packages/Magick.NET-Q16-AnyCPU/7.15.5) | [Apache License v2](https://github.com/dlemstra/Magick.NET/blob/master/License.txt) | The .NET library for [ImageMagick](https://imagemagick.org/index.php) | |
...
| Nerdbank.GitVersioning | [GitHub](https://github.com/dotnet/Nerdbank.GitVersioning) | [3.1.74](https://www.nuget.org/packages/Nerdbank.GitVersioning/3.1.74) | [MIT](https://opensource.org/licenses/MIT) | Adds git version info to assemblies on build | |
